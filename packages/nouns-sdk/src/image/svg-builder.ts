...
export const buildSVG = (
  ...
  const svgWithoutEndTag = parts.reduce((result, part) => {
    ...
    return result;
  }, `<svg width="320" height="320" viewBox="0 0 320 320" xmlns="http://www.w3.org/2000/svg" shape-rendering="crispEdges"><rect width="100%" height="100%" fill="#${bgColor}" ${transparent ? `fill-opacity="0"` : ``} />`);
