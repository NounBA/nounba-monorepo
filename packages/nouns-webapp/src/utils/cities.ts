...
export const west = [
  { id: 1, displayName: 'Referee 1', tokenIndex: 1 },
  ...
  { id: 27, displayName: 'Referee 5', tokenIndex: 15 },
...
export const east = [
  { id: 2, displayName: 'Referee 2', tokenIndex: 21 },
  ...
  { id: 16, displayName: 'Referee 4', tokenIndex: 28 },
  ...
  { id: 30, displayName: 'Referee 6', tokenIndex: 35 },
