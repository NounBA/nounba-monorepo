      ...
      <Accordion flush>
          ...
          <Accordion.Body>
            ...
            <p className={classes.aboutText}>
              <Trans>
                ...
                time], 2 simultaneous [duration in hours] auctions will be kicked off. Each time an
                auction is settled, a new NounBA will be minted and a new [duration in hours]
          ...
          <Accordion.Body>
            <p>
              <Trans>
                ...
                basketball teams. No copyright or official team IP is featured (e.g. names, logos).
                NounBA traits match the structure of Noun traits (background, body, accessory, head,
                glasses).
              </Trans>
            </p>
          </Accordion.Body>
        ...
        <Accordion.Item eventKey="6" className={classes.accordionItem}>
          ...
          <Accordion.Body>
            ...
            <p>
              NounBA founders will be compensated with 6 NounBAs and 12% of the 34 auction proceeds.
            </p>
          </Accordion.Body>
        </Accordion.Item>
      </Accordion>
